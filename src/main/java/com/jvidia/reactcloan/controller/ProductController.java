...
import com.jvidia.reactcloan.common.DisplayCriteria;
import com.jvidia.reactcloan.entity.Product;
import com.jvidia.reactcloan.service.ProductService;
...
public class ProductController {
    ...
    static final List<String> PROD_LIST = List.of("Abundance", "Acclimaze", "Accruex", "Adornica", "Aerosol Cheese", "Aftertizer",
    ...
    public void init() {
        ...
        allProducts.stream().forEach(System.out::print);
    }
