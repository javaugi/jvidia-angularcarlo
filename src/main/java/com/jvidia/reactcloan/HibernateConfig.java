 ...
 */
@Configuration
@ComponentScan(basePackages = {HibernateConfig.PACKAGES_TO_SCAN})
@EnableHypermediaSupport(type = EnableHypermediaSupport.HypermediaType.HAL)
@EnableJpaRepositories(basePackages = {HibernateConfig.PACKAGES_TO_SCAN})
@EnableTransactionManagement
public class HibernateConfig {
    protected static final String PACKAGES_TO_SCAN = "com.jvidia";
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
        ...
        bean.setPackagesToScan(HibernateConfig.PACKAGES_TO_SCAN);
        return bean;
    }    
    // */
